...
var Mediabunny = (() => {
  ...
  var EBMLReader = class {
    ...
    readUnicodeString(length) {
      ...
      return textDecoder.decode(new Uint8Array(view2.buffer, offset, strLength));
    }
    readElementId() {
...
${cue.notes ?? ""}`;
  ...
  var canEncodeVideo = async (codec, {
    width = 1280,
    height = 720,
    bitrate = 1e6,
    ...restOptions
  ...
  var canEncodeAudio = async (codec, {
    numberOfChannels = 2,
    sampleRate = 48e3,
    bitrate = 128e3,
    ...restOptions
  ...
  var UrlSource = class extends Source {
    constructor(url2, options = {}) {
      ...
      this._url = url2 instanceof URL ? url2 : new URL(url2, location.href);
      this._options = options;
    }
    /** @internal */
