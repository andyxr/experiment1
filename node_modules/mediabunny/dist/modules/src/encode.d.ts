 ...
 */
import { AudioCodec, MediaCodec, Quality, SubtitleCodec, VideoCodec } from './codec';
 ...
 * @public
 */
export declare const canEncodeVideo: (codec: VideoCodec, { width, height, bitrate, ...restOptions }?: {
    width?: number;
    height?: number;
    bitrate?: number | Quality;
 ...
 * @public
 */
export declare const canEncodeAudio: (codec: AudioCodec, { numberOfChannels, sampleRate, bitrate, ...restOptions }?: {
    numberOfChannels?: number;
    sampleRate?: number;
    bitrate?: number | Quality;
