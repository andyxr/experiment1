 ...
 */
import { AUDIO_CODECS, buildAudioCodecString, buildVideoCodecString, getAudioEncoderConfigExtension, getVideoEncoderConfigExtension, inferCodecFromCodecString, PCM_AUDIO_CODECS, Quality, SUBTITLE_CODECS, VIDEO_CODECS, } from './codec.js';
 ...
 * @public
 */
export const canEncodeVideo = async (codec, { width = 1280, height = 720, bitrate = 1e6, ...restOptions } = {}) => {
    if (!VIDEO_CODECS.includes(codec)) {
        return false;
    }
 ...
 * @public
 */
export const canEncodeAudio = async (codec, { numberOfChannels = 2, sampleRate = 48000, bitrate = 128e3, ...restOptions } = {}) => {
